    ...
    class DisbursementVouchersCreate extends Component implements HasForms
    {
                        ...
                        ->schema([
                            Card::make()->schema([
                                Select::make('voucher_subtype_id')
                                    ...
                                    ->options(VoucherSubType::with('voucher_type')->get()->map(fn($v) => [
                                        'id' => $v->id, 'name' => "{$v->voucher_type->name} - {$v->name}"
                                    ])->pluck('name', 'id'))
                                    ->disabled()
                                ...
                                Select::make('travel_order_id')
                                    ...
                                    ->options(
                                        TravelOrder::query()
                                            ->where(function ($q) {
                                                $q->where(function ($q) {
                                                    $q->where('travel_order_type_id',
                                                        TravelOrderType::OFFICIAL_BUSINESS)
                                ...
                                Grid::make(2)->schema([
                                    TextInput::make('payee')
                                        ->disabled(fn($get
                                        ) => $get('payee_mode') == 'self' || in_array($this->voucher_subtype->voucher_type_id,
                                                [1, 2]))
                                        ->required()
                                        ...
                                        TextInput::make('electricity_consumption')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('electricity_cost') == '' || ($get('electricity_cost') == null)) {
                                                        $cost = 0;
                                                        $consumption = $state;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('electricity_cost') == '' || $get('electricity_cost') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                        ...
                                        TextInput::make('electricity_cost')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('electricity_consumption') == '' || $get('electricity_consumption') == null) {
                                                        $cost = $state;
                                                        $consumption = 0;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('electricity_consumption') == '' || $get('electricity_consumption') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                        ...
                                        TextInput::make('water_consumption')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('water_cost') == '' || ($get('water_cost') == null)) {
                                                        $cost = 0;
                                                        $consumption = $state;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('water_cost') == '' || $get('water_cost') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                                ...
                                                $other_expense = collect($this->other_expenses);
                                                $total = round($utility_particulars->sum('water_total') + $other_expense->sum('amount'),
                                                    2);
                                                $set('../../disbursement_voucher_particulars', [
                                                    [
                                                        'purpose' => $get('../../purpose'),
                                        ...
                                        TextInput::make('water_cost')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('water_consumption') == '' || $get('water_consumption') == null) {
                                                        $cost = $state;
                                                        $consumption = 0;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('water_consumption') == '' || $get('water_consumption') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                                ...
                                                $utility_particulars = collect($this->water_utility_particulars);
                                                $other_expense = collect($this->other_expenses);
                                                $total = round($utility_particulars->sum('water_total'),
                                                        2) + round($other_expense->sum('amount'), 2);
                                                $set('../../disbursement_voucher_particulars', [
                                                    [
                                                        'purpose' => $get('../../purpose'),
                                                        'responsibility_center' => '',
                                        ...
                                        TextInput::make('fuel_consumption')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('fuel_cost') == '' || ($get('fuel_cost') == null)) {
                                                        $cost = 0;
                                                        $consumption = $state;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('fuel_cost') == '' || $get('fuel_cost') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                                ...
                                                $other_expense = collect($this->other_expenses);
                                                $total = round($utility_particulars->sum('fuel_total') + $other_expense->sum('amount'),
                                                    2);
                                                $set('../../disbursement_voucher_particulars', [
                                                    [
                                                        'purpose' => $get('../../purpose'),
                                        ...
                                        TextInput::make('fuel_cost')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                if ($state == '' || $state == null) {
                                                    ...
                                                    if ($get('fuel_consumption') == '' || $get('fuel_consumption') == null) {
                                                        $cost = $state;
                                                        $consumption = 0;
                                                    } else {
                                                        if (($state == '' || $state == null) && ($get('fuel_consumption') == '' || $get('fuel_consumption') == null)) {
                                                            $cost = 0;
                                                            $consumption = 0;
                                                        } else {
                                                            $cost = $state;
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('telephone_amount')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                ...
                                                $other_expense = collect($this->other_expenses);
                                                $total = round($utility_particulars->sum('telephone_amount') + $other_expense->sum('amount'),
                                                    2);
                                                $set('../../disbursement_voucher_particulars', [
                                                    [
                                                        'purpose' => $get('../../purpose'),
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('internet_amount')
                                            ...
                                            ->afterStateUpdated(function ($set, $get, $state) {
                                                ...
                                                $other_expense = collect($this->other_expenses);
                                                $total = round($utility_particulars->sum('internet_amount') + $other_expense->sum('amount'),
                                                    2);
                                                $set('../../disbursement_voucher_particulars', [
                                                    [
                                                        'purpose' => $get('../../purpose'),
                                ...
                                Repeater::make('other_expenses')
                                                    ...
                                                    if ($this->voucher_subtype->id == 27) {
                                                        ...
                                                        if ($this->voucher_subtype->id == 70) {
                                                            ...
                                                            if ($this->voucher_subtype->id == 71) {
                                                                ...
                                                                if ($this->voucher_subtype->id == 74) {
                                                                    $utility_particulars = collect($this->telephone_utility_particulars);
                                                                    $total = round(($utility_particulars->sum('telephone_amount') + $sum),
                                                                        2);
                                                                } else {
                                                                    if ($this->voucher_subtype->id == 75) {
                                                                        $utility_particulars = collect($this->internet_utility_particulars);
                                                                        $total = round(($utility_particulars->sum('internet_amount') + $sum),
                                                                            2);
                                                                    }
                                                                }
                                                            }
                                    ...
                                    ])->createItemButtonLabel('Add New Row')->visible(fn($get
                                    ) => in_array($this->voucher_subtype->id, [27, 70, 71, 74, 75])),
                                ...
                                Repeater::make('disbursement_voucher_particulars')
                                    ...
                                    ->minItems(1)
                                    ->visible(fn($get
                                    ) => $get('travel_order_id') || !in_array($this->voucher_subtype->id,
                                            VoucherSubType::TRAVELS))
                                    ->disableItemDeletion(fn() => in_array($this->voucher_subtype->id,
                                        VoucherSubType::TRAVELS))
                                    ->disableItemCreation(fn() => in_array($this->voucher_subtype->id,
                                        VoucherSubType::TRAVELS)),
                                #endregion
                            ]),
        ...
        private function itinerarySection()
        {
            if (!in_array($this->voucher_subtype->id, VoucherSubType::TRAVELS)) {
                ...
                return [
                    Step::make(in_array($this->voucher_subtype->id,
                        [6, 7]) ? 'Print Actual Itinerary' : 'Print Itinerary')
                        ->schema([
                            Card::make()
                                ->schema([
        ...
        {
            return TravelOrder::find($this->travel_order_id)?->travel_order_type_id == TravelOrderType::OFFICIAL_BUSINESS && in_array($this->voucher_subtype->id,
                    [6, 7]);
        }
