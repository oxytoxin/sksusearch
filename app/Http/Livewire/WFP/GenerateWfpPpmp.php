<?php
    ...
    class GenerateWfpPpmp extends Component
    {
        ...
        public function gasPpmp()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)->where('is_supplemental',
                    0)->where('fund_cluster_id', 1)->whereHas('costCenter', function ($query) {
        ...
        public function hesPpmp()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_supplemental', 0)->where('is_approved',
                    1)->where('fund_cluster_id', 1)->whereHas('costCenter', function ($query) {
        ...
        public function sksuPpmp161()
        {
            ...
            $this->title = 'Sultan Kudarat State University';
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('fund_cluster_id', 3)
        ...
        public function gasPpmp161()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 3)->whereHas('costCenter',
                        function ($query) {
                            $query->where('m_f_o_s_id', 1);
                        });
            })
        ...
        public function accessPpmp163()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 2)->whereHas('costCenter',
                        function ($query) {
        ...
        public function sksuPpmp164T()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 4)->where('is_approved', 1);
            })
                ->with(['supply', 'categoryItem'])  // Load both relationships
                ->selectRaw('supply_id, category_item_id, uacs_code, budget_category_id, uom, SUM(total_quantity) as total_quantity, cost_per_unit, SUM(cost_per_unit * total_quantity) as estimated_budget, JSON_ARRAYAGG(quantity_year) as merged_quantities')
                ->groupBy('supply_id', 'category_item_id', 'uacs_code', 'cost_per_unit', 'uom', 'budget_category_id')
        ...
        public function gasPpmp164T()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 4)->whereHas('costCenter',
                        function ($query) {
                            $query->where('m_f_o_s_id', 1);
                        });
            })
        ...
        public function gasPpmp164TN()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 7)->whereHas('costCenter',
                        function ($query) {
                            $query->where('m_f_o_s_id', 1);
                        });
            })
        ...
        public function gasPpmp164OSF()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 5)->whereHas('costCenter',
                        function ($query) {
                            $query->where('m_f_o_s_id', 1);
                        });
            })
        ...
        public function gasPpmp164MF()
        {
            ...
            $this->record = WfpDetail::where('is_ppmp', 1)->whereHas('wfp', function ($query) {
                $query->where('wpf_type_id', $this->selectedType)->where('is_approved', 1)
                    ->where('is_supplemental', 0)->where('fund_cluster_id', 6)->whereHas('costCenter',
                        function ($query) {
                            $query->where('m_f_o_s_id', 1);
                        });
            })
