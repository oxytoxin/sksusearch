            ...
            return [
                Tables\Actions\ActionGroup::make([
                    ...
                    Action::make('view ppmp')
                        ...
                        ->url(fn($record): string => route('wfp.print-ppmp', [
                            'record' => $record, 'isSupplemental' => 1, 'wfpType' => $this->data['wfp_type_id'],
                ...
                Action::make('approve')
                    ...
                    ->action(function ($record) {
                        ...
                        //                             );
                        //
                        //                             Log::info('WFP approval SMS queued successfully (Q1)', [
                        //                                 'phone' => $phone,
                        //                                 'user_id' => $user->id,
                        //                                 'user_name' => $user->name,
                        //                                 'wfp_id' => $record->id,
                        ...
                        //     }
                        // } catch (\Exception $e) {
                        //     Log::error('WFP approval SMS notification failed (Q1)', [
                        //         'error' => $e->getMessage(),
                        //         'line' => $e->getLine(),
                        //         'file' => $e->getFile(),
                ...
                Action::make('modify')
                    ...
                    ->action(function ($record, $data) {
                        ...
                        //                             );
                        //
                        //                             Log::info('WFP modification request SMS queued successfully (Q1)', [
                        //                                 'phone' => $phone,
                        //                                 'user_id' => $user->id,
                        //                                 'user_name' => $user->name,
                        //                                 'wfp_id' => $record->id,
                        ...
                        //     }
                        // } catch (\Exception $e) {
                        //     Log::error('WFP modification request SMS notification failed (Q1)', [
                        //         'error' => $e->getMessage(),
                        //         'line' => $e->getLine(),
                        //         'file' => $e->getFile(),
                        //         'wfp_id' => $record->id ?? null,
