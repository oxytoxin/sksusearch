...
class BankAccount extends Model
{
    ...
    public function active_check_stub(): HasOne
    {
        return $this->hasOne(CheckStub::class)
            ->where('status', CheckStub::STATUS_ACTIVE)
            ->oldestOfMany();
    }

    public function active_notice_of_cash_allocations(): HasMany
    {
        return $this->notice_of_cash_allocations()
            ->where('status', NoticeOfCashAllocation::STATUS_ACTIVE);
    }
}
