...
{
    public const OPERATION_CREDIT = 1;

    public const OPERATION_DEBIT = 2;

    public const OPERATOR_INCREASE = 1;

    public const OPERATOR_DECREASE = -1;
    ...
    public function isReversion(): bool
    {
        return $this->category === self::CATEGORY_REVERSION;
    }
}
