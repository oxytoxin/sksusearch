<x-app-layout>
    <div>
        <div class="mx-auto flex max-w-[90%] border-collapse print:block print:h-[297mm] print:max-h-[297mm] print:w-[220mm] print:max-w-[220mm]" id="dvPrint">
                    ...
                    <div class="flex min-w-full place-items-center justify-between">
                        <div class="ml-1 mt-1 flex">
                            <div class="my-auto flow-root">
                                <div class="mr-2 inline-block">
                                    <img class="mx-auto h-full w-14 object-scale-down" src="{{ asset('images/sksulogo.png') }}" alt="sksu logo">
                        ...
                        <div class="flex">
                            <div class="m-3 text-center">
                                ...
                                <img class="mx-auto h-auto w-12" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ route('disbursement-vouchers.show-from-trn', ['disbursement_voucher' => $disbursement_voucher->tracking_number]) }}" alt="N/A">
                            ...
                            <div class="relative flex items-start">
                                <div class="flex h-5 items-center">
                                    @if ($mop->id == $disbursement_voucher->mop_id)
                                        <input class="h-4 w-4 border-black text-indigo-500 focus:ring-primary-500" id="comments" name="comments" type="checkbox" aria-describedby="comments-description" readonly disabled checked>
                                    @else
                                        <input class="h-4 w-4 border-black text-primary-500 focus:ring-primary-500" id="comments" name="comments" type="checkbox" aria-describedby="comments-description" readonly disabled>
                                    @endif
                                </div>
        ...
        <div class="mx-auto mt-4 max-w-[90%]">
            <button class="mt-2 inline-flex items-center rounded-md border border-transparent bg-primary-500 px-4 py-2 text-xs font-medium text-white shadow-sm hover:bg-primary-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2" type="button" onclick="printDiv('dvPrint')">
