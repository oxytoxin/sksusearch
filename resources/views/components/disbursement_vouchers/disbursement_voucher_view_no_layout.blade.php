    ...
    <div class="mx-auto flex max-w-[90%] border-collapse print:block print:h-[297mm] print:max-h-[297mm] print:w-[220mm] print:max-w-[220mm]"
        ...
        <div class="flex flex-col">
            ...
            <div class="col-span-8 flex min-w-full items-stretch border-t-2 border-black font-serif print:text-12">
                <div class="min-h-[11rem] w-1/2 border-r-2 border-black">
                ...
                <div class="min-h-[11rem] w-72 border-r-2 border-black">
                    @forelse ($disbursement_voucher->uacs_allocations as $allocation)
                ...
                <div class="min-h-[11rem] w-28 border-r-2 border-black">
                    @forelse ($disbursement_voucher->uacs_allocations as $allocation)
                ...
                <div class="min-h-[11rem] w-28 text-center">
                    &nbsp
                </div>
            </div>
            <div class="col-span-8 flex min-w-full items-start border-t-2 border-black font-serif print:text-12">
