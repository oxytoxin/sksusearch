							...
							<div class="flex items-center h-5">
								@if ($mop == 'MD5')
									<input id="comments" aria-describedby="comments-description" name="comments" type="checkbox"
										class="w-4 h-4 border-black text-primary-500 focus:ring-primary-500" readonly disabled checked>
								@else
									<input id="comments" aria-describedby="comments-description" name="comments" type="checkbox"
										class="w-4 h-4 border-black text-primary-500 focus:ring-primary-500" readonly disabled>
								@endif
				...
				<div class="flex items-start min-w-full col-span-8 font-serif border-t-2 border-black print:text-12">
					<div class="flex-col w-full">
						...
						<div class="flex flex-row w-full border-b-2 border-black">
							...
							<div class="w-1/3 h-auto border-r border-black shrink-0"><div class="h-5"></div></div>
