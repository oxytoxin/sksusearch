                ...
                <div id="header" class="block w-full items-start text-left">
                    ...
                    <div class="flex justify-between">
                        <div class="space-x-4">
                            <div class="">
                                ...
                                <span
                                    class="text-sm font-semibold tracking-wide text-black ">{{ Carbon\Carbon::parse($fuel_request->created_at)->format('F d, Y') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-x-4">
                            <div class="grid grid-cols-2">
                                <span class="col-span-1 text-sm font-semibold tracking-wide text-red-600">Slip
                                    No.</span>
                                <span
                                    class="col-span-1 text-sm font-semibold tracking-wide text-black ">{{ $fuel_request->slip_number }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-col mt-8">
                        <div class="space-x-4">
                            ...
                            <span
                                class="text-sm font-semibold tracking-wide text-black ">{{ $fuel_request->supplier->name }}</span>
                        </div>
                        <div class="space-x-5">
                            <span class="text-sm font-semibold tracking-wide text-black">Address:</span>
                            <span
                                class="text-sm font-semibold tracking-wide text-black">{{ $fuel_request->supplier->address }}</span>
                        </div>
                    </div>
                    ...
                    <div>
                                ...
                                <tr class="p-2 ">
                                    ...
                                    <td class="border-t border-gray-800 text-center">
                                        <div class="flex space-x-8 justify-center items-center">
                                            <div>
                                                <input disabled
                                                    {{ $fuel_request->article === 'Gasoline' ? 'checked' : '' }}
                                                    type="checkbox">
                                                <label for="">Gasoline</label>
                                            </div>
                                            <div>
                                                <input disabled
                                                    {{ $fuel_request->article === 'Diesel' ? 'checked' : '' }}
                                                    type="checkbox">
                                ...
                                <tr class="p-2 ">
                                    ...
                                    <td class="border-t border-gray-800 text-center">
                                        <div class="flex space-x-8 justify-center items-center">
                                            <div>
                                                <input disabled
                                                    {{ $fuel_request->article === 'Others' ? 'checked' : '' }}
                                                    type="checkbox">
                        ...
                        @php
                            $slipVehicle = $fuel_request->request_schedule?->vehicle;
                        ...
                        <div class="flex-col mt-8">
                            ...
                            @endif
                            @if ($fuel_request->odometer_reading !== null)
                                <div class="space-x-4">
                                    <span class="text-sm font-semibold tracking-wide text-black">Odometer Reading:</span>
                                    <span class="text-sm font-semibold tracking-wide text-black">{{ number_format($fuel_request->odometer_reading) }} km</span>
                                </div>
                            @endif
                            <div class="space-x-4">
                                <span class="text-sm font-semibold tracking-wide text-black">Purpose:</span>
                                <span
                                    class="text-sm font-semibold tracking-wide text-black ">{{ $fuel_request->purpose }}</span>
                            </div>
                            <div class="space-x-5">
