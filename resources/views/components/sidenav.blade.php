<nav class="flex flex-col space-y-1 px-2 md:mt-5" x-data x-cloak>
    ...
    <div class="space-y-1" x-data="{ open: false }">
        ...
        <button
            class="group flex w-full items-center rounded-md py-2 pr-2 text-left text-sm font-medium text-primary-600 hover:bg-primary-50 hover:text-primary-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
    ...
    <div class="space-y-1" x-data="{ open: false }">
        ...
        <div class="space-y-1" class="origin-top-left" id="sub-menu-1" x-show='open'
             ...
             x-transition:leave-start='opacity-100 scale-100' x-transition:leave-end='opacity-0 scale-95'>
            <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
               href="{{ route('requisitioner.disbursement-vouchers.unliquidated') }}" href="#">
                Unliquidated
            </a>
            @php
    ...
    <div class="space-y-1" x-data="{ open: false }">
        ...
        <div class="space-y-1" class="origin-top-left" id="sub-menu-1" x-show='open'
            ...
            @if ($isAccountant)
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('pcv.accountant.dashboard') }}">
        ...
        <div class="space-y-1" x-data="{ open: false }">
            ...
            <div class="space-y-1" class="origin-top-left" id="sub-menu-1" x-show='open'
                ...
                @if ($isFinance)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.wfp-types') }}">
                        WFP Period
                    </a>
                @endif
                @if ($isFinance || $isPresident)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.fund-allocation', 1) }}">
                        Fund Allocation
                    </a>
                @endif
                @if ($isFinance || $is_reizza || $is_nolaila)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.wfp-submissions', 1) }}">
                        WFP Submissions
                    </a>
                @endif
                @if ($isFinance)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.generate-wfp-ppmp') }}">
                        Generate PPMP
                    </a>
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.generate-ppmp') }}">
                        Generate PRE
                    </a>

                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.reported-supply-list') }}">
                        Reported Supplies
                    </a>
                @endif
                ...
                @if ($isAccountant)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.accounting-requested-suppluies') }}">
                        Requested Supplies
                    </a>
                @endif
                @if ($isOfficeHead && $costCenterExist)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.assign-personnel') }}">
                        Assign Personnel
                    </a>
                @endif
                @if (($isOfficeHead && $costCenterExist) || $isAssignedPersonnel)
                    ...
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.wfp-history') }}">
                        WFP History
                    </a>
                @endif
                @if ($isSupply)
                    <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                       href="{{ route('wfp.supply-requested-suppluies') }}">
                        Requested Supplies
                    </a>
                @endif
        ...
        <a class="group flex w-full items-center rounded-md py-2 pr-2 text-left text-sm font-medium text-primary-600 hover:bg-primary-50 hover:text-primary-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
           href="{{ config('app.v2_url') . '/activity-designs' }}" aria-controls="sub-menu-1" aria-expanded="false">
            <!-- Expanded: "text-primary-400 rotate-90", Collapsed: "text-primary-300" -->
            <svg class="" aria-hidden="true" :class="open ?
                'rotate-90 flex-shrink-0 w-5 h-5 mr-2 text-primary-300 transition-colors duration-150 ease-in-out transform group-hover:text-primary-400' :
                'flex-shrink-0 w-5 h-5 mr-2 text-primary-300 transition-colors duration-150 ease-in-out transform group-hover:text-primary-400'"
        ...
        <div class="space-y-1" x-data="{ open: false }">
            ...
            <div class="space-y-1" class="origin-top-left" id="sub-menu-1" x-show='open'
                 ...
                 x-transition:leave-start='opacity-100 scale-100' x-transition:leave-end='opacity-0 scale-95'>
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('cashier.reports.rci') }}">
                    Report of Checks Issued
                </a>
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('cashier.reports.radai') }}">
                    Report of Advice to Debit Account Issued
                </a>
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('cashier.reports.acic') }}">
                    Advice of Checks Issued and Cancelled
                </a>
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('cashier.reports.lddap-ada') }}">
                    LDDAP-ADA Summary Report
                </a>
                <a class="group flex w-full items-center rounded-md py-2 pl-10 pr-2 text-sm font-medium text-primary-600 hover:bg-primary-100 hover:text-primary-900"
                   href="{{ route('cashier.reports.sliee') }}">
                    SLIIE Report
                </a>
