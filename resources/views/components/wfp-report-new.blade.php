        ...
        <div class="flex justify-between">
            ...
            <div class="p-6 flex-col text-sm w-1/4 font-medium divide-y-2 divide-gray-800">
                ...
                <div class="py-2">
                    ...
                    <span
                        class="text-center">{{ $record->costCenter->office->head_employee?->full_name . ' - ' . $record->costCenter->office->name }}</span>
                </div>
            </div>
                ...
                <div class=" min-w-full py-2 align-middle sm:px-6 lg:px-2">
                    <table class="min-w-full">
                        ...
                        <thead class="bg-white">
                            <tr>
                                <th scope="col" class="px-1 py-1 text-left text-sm font-semibold text-gray-900">UACS
                                    Code</th>
                                ...
                                <th scope="col" class="px-1 py-1 text-left text-sm font-semibold text-gray-900">
                                    Supply Code</th>
                                <th scope="col" class="px-1 py-1 text-left text-sm font-semibold text-gray-900">Qty
                                </th>
                                <th scope="col" class="px-1 py-1 text-left text-sm font-semibold text-gray-900">UOM
                                </th>
                                <th scope="col" class="px-1 py-1 text-right text-sm font-semibold text-gray-900">Unit
                                    Cost (₱)</th>
                        ...
                        <tbody class="bg-white">
                          ...
                          text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems->where('budget_category_id', 1) as $item)
                                    <tr class="border-t border-gray-300">
                                        ...
                                        @foreach (json_decode($item->quantity) as $quantity)
                                            <td
                                                class="whitespace-nowrap px-1 text-center py-2 text-sm text-gray-500 border-l border-gray-400">
                                                {{ $quantity }}
                                            </td>
                                        @endforeach
                                    </tr>
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 1)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                          ...
                          text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems->where('budget_category_id', 2) as $item)
                                    <tr class="border-t border-gray-300">
                                        <td
                                            class="whitespace-nowrap py-2 pl-2 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                                            {{ $item->uacs ?? 'none' }}
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 2)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                                            class="bg-gray-100 py-2 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-3">
                                            No Record</th>
                          ...
                          text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems?->where('budget_category_id', 3) as $item)
                                    <tr class="border-t border-gray-300">
                                        <td
                                            class="whitespace-nowrap py-2 pl-2 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                                            {{ $item->uacs ?? 'none' }}
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 3)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                                            class="bg-gray-100 py-2 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-3">
                                            No Record</th>
                          ...
                          text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems->where('budget_category_id', 4) as $item)
                                    <tr class="border-t border-gray-300">
                                        <td
                                            class="whitespace-nowrap py-2 pl-2 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                                            {{ $item->uacs ?? 'none' }}
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 4)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                                            class="bg-gray-100 py-2 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-3">
                                            No Record</th>
                          ...
                          text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems->where('budget_category_id', 5) as $item)
                                    <tr class="border-t border-gray-300">
                                        <td
                                            class="whitespace-nowrap py-2 pl-2 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                                            {{ $item->uacs ?? 'none' }}
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 5)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                                            class="bg-gray-100 py-2 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-3">
                                            No Record</th>
                        ...
                        text-left text-sm font-semibold text-gray-900 sm:pl-3">
                            ...
                            {{-- TEMP --}}
                            @if ($draftItems)
                                @foreach ($draftItems->where('budget_category_id', 6) as $item)
                                    <tr class="border-t border-gray-300">
                                        <td
                                            class="whitespace-nowrap py-2 pl-2 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                                            {{ $item->uacs ?? 'none' }}
                            ...
                            @empty
                                @if (!$draftItems || $draftItems->where('budget_category_id', 6)->count() === 0)
                                    <tr class="border-t border-gray-200">
                                        <th colspan="21" scope="colgroup"
                                            class="bg-gray-100 py-2 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-3">
                                            No Record</th>
