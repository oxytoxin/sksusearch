<div wire:ignore.self class="bg-gray-100 px-2 py-4 rounded-lg">
    <div class="grid grid-cols-2">
        @php
        $name = App\Models\BudgetCategory::where('id', 4)->first()->name;
        @endphp
        ...
        <div class="grid grid-cols-3 space-x-4">
            <div class="sm:col-span-2">
                <div class="flex justify-between">
                    ...
                    @if ($machine_particular_id)
                    <label class="block text-xs font-medium leading-4 text-red-900 underline cursor-pointer"><a href="{{route('wfp.report-supply',  ['record' => $machine_particular_id])}}">Report Supply</a></label>
                    @endif
