        ...
        <div class="sm:col-span-1 mt-4">
          ...
          <div class="mt-3 grid grid-cols-4 space-x-4 justify-center">
            ...
            <div class="sm:col-span-1">
                ...
                <div class="mt-2">
                  <input wire:model="training_cost_per_unit" {{$training_ppmp || $training_particular_id === null ? 'disabled' : ''}} id="training_cost_per_unit" name="training_cost_per_unit" type="text" autocomplete="" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
