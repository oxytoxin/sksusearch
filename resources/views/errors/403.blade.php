        ...
        <main class="flex flex-col justify-center flex-grow w-full px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex justify-center flex-shrink-0">
                <a href="/" class="inline-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-auto h-52 md:h-96" xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1" width="797.5" height="834.5" viewBox="0 0 797.5 834.5">
                        <title>void</title>
            ...
            <div class="py-16">
                <div class="text-center">
                    ...
                    <h2 class="mt-2 font-bold tracking-tight text-primary-600 sm:text-2xl">
