<x-guest-layout>
    <div class="flex min-h-full flex-col bg-white pt-16 pb-12">
        <main class="mx-auto flex w-full max-w-7xl flex-grow flex-col justify-center px-4 sm:px-6 lg:px-8">
            <div class="flex flex-shrink-0 justify-center">
                <a href="/" class="inline-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-52 w-auto md:h-96"
                        xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1" width="797.5" height="834.5"
                        ...
                        <path
                            ...
                            transform="translate(-201.25 -32.75)" fill="#2f2e41" />
                        <circle cx="559" cy="744.5" r="43" fill="#077f13" />
                        <circle cx="54" cy="729.5" r="43" fill="#077f13" />
                        <circle cx="54" cy="672.5" r="31" fill="#077f13" />
                        <circle cx="54" cy="624.5" r="22" fill="#077f13" />
                    </svg>
                </a>
            </div>
            <div class="py-16">
        ...
        <footer class="mx-auto w-full max-w-7xl flex-shrink-0 px-4 sm:px-6 lg:px-8 hidden">
