    ...
    <div class="flex flex-col min-h-full pt-16 pb-12 bg-white">
        <main class="flex flex-col justify-center flex-grow w-full px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex justify-center flex-shrink-0">
                <a href="/" class="inline-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-auto h-48 lg:h-96" data-name="Layer 1" width="1119.60911" height="699" viewBox="0 0 1119.60911 699">
                        ...
                        <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356" transform="translate(-31.39089 -100.5)" fill="#0c6600" />
                        <path d="M70.77521,158.66768c0,73.61476,31.00285,133.18288,69.31641,133.18288" transform="translate(-31.39089 -100.5)" fill="#0c6600" />
                        ...
                        <rect x="271.60911" y="150" width="16" height="16" fill="#0c6600" opacity="0.4" />
                        <rect x="294.60911" y="150" width="16" height="16" fill="#0c6600" opacity="0.8" />
                        <rect x="317.60911" y="150" width="16" height="16" fill="#0c6600" />
                        <rect x="271.60911" y="251" width="16" height="16" fill="#0c6600" opacity="0.4" />
                        <rect x="294.60911" y="251" width="16" height="16" fill="#0c6600" opacity="0.8" />
                        <rect x="317.60911" y="251" width="16" height="16" fill="#0c6600" />
                        <rect x="271.60911" y="352" width="16" height="16" fill="#0c6600" opacity="0.4" />
                        <rect x="294.60911" y="352" width="16" height="16" fill="#0c6600" opacity="0.8" />
                        <rect x="317.60911" y="352" width="16" height="16" fill="#0c6600" />
                        ...
                        <path d="M271.36733,565.03228c-6.37889-28.56758,14.01185-57.43392,45.544-64.47477s62.2651,10.41,68.644,38.9776-14.51861,39.10379-46.05075,46.14464S277.74622,593.59986,271.36733,565.03228Z"
                            transform="translate(-31.39089 -100.5)" fill="#0c6600" />
            ...
            <div class="py-16">
                <div class="text-center">
                    <h1 class="text-3xl font-semibold text-gray-900">500</h1>
                    <h2 class="mt-2 text-4xl font-bold tracking-tight text-primary-600 sm:text-5xl">
                        An error on the server occurred</h2>
                    <div class="mt-6">
                        <a href="/" class="text-base font-medium text-gray-900 hover:text-primary-400">
                            Go back home
        ...
        <footer class="flex-shrink-0 w-full px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <nav class="flex justify-center space-x-4">
                <a href="mailto:sksusearch@sksu.edu.ph?body={{ rawurlencode($exception->getMessage()) }}" target="_blank" class="text-sm font-medium text-gray-500 hover:text-gray-600">Contact Support</a>
            </nav>
        </footer>
    </div>
</x-guest-layout>
