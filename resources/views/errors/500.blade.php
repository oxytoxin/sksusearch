    ...
    <div class="flex min-h-full flex-col bg-white pt-16 pb-12">
            ...
            <div class="flex flex-shrink-0 justify-center">
                <a href="/" class="inline-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        class="w-auto h-48 lg:h-96" data-name="Layer 1" width="1119.60911" height="699"
        ...
        <footer class="mx-auto w-full max-w-7xl flex-shrink-0 px-4 sm:px-6 lg:px-8">
            <nav class="flex justify-center space-x-4">
                <a href="mailto:sksusearch@sksu.edu.ph?body={{ rawurlencode($exception->getMessage()) }}"
                    target="_blank" class="text-sm font-medium text-gray-500 hover:text-gray-600">Contact Support</a>
