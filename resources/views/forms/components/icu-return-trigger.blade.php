<div class="flex justify-end mt-2" wire:loading.remove wire:target="openIcuReturnFromVerify">
    <button
        type="button"
        wire:click="openIcuReturnFromVerify('{{ $recordId }}')"
        wire:loading.attr="disabled"
        wire:target="openIcuReturnFromVerify"
...
<div class="flex justify-end mt-2" wire:loading wire:target="openIcuReturnFromVerify">
