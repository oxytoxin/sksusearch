<div x-data>
    <div class="p-4">
        <div class="flex justify-center">
            <button @click="showPrintable = true" wire:click="sksuPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-8 rounded-lg">
                SKSU 101
            </button>
        </div>
        <div class="flex justify-center space-x-4 mt-3">
            <button @click="showPrintable = true" wire:click="gasPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                General Admission and Support Services (GASS)
            </button>
            <button @click="showPrintable = true" wire:click="hesPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                Higher Education Services (HES)
            </button>
            <button @click="showPrintable = true" wire:click="aesPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                Advanced Education Services (AES)
            </button>
            <button @click="showPrintable = true" wire:click="rdPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                Research and Development (RD)
            </button>
            <button @click="showPrintable = true" wire:click="extensionPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                Extension Services (ES)
            </button>
            <button @click="showPrintable = true" wire:click="lfPpmp" class="bg-green-800 hover:bg-green-700 text-white font-bold py-1.5 px-3 rounded-lg">
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="border-t border-gray-200">
                          ...
                          <tr class="border-t border-gray-300">
                            ...
                            <td class="px-1 py-2 text-sm text-gray-500 text-wrap">{{$item->categoryItem->name}}</td>
                            <td class="px-1 py-2 text-sm text-gray-500 text-wrap">{{$item->supply->particulars}}</td>
                            <td class="px-1 py-2 text-sm text-gray-500 text-wrap">{{$item->supply->supply_code}}</td>
                            <td class="px-1 py-2 text-sm text-gray-500 text-wrap">{{$item->total_quantity}}</td>
                            ...
                            <td class="whitespace-nowrap px-1 py-2 text-sm text-right text-gray-500">{{number_format((float)($item->cost_per_unit * $item->total_quantity), 2, '.', ',') }}</td>
                            @foreach ($item->merged_quantities as $quantity)
                            <td class="whitespace-nowrap px-1 py-2 text-sm text-center text-gray-500 border-l border-gray-400">{{$quantity}}</td>
                            @endforeach
                          </tr>
                        @empty
                        <tr class="border-t border-gray-200">
