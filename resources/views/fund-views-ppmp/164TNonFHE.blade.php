                  ...
                  <table class="min-w-full">
                    ...
                    <thead class="bg-white">
                      <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Unit Cost (₱st)</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Estimated Budget (₱st)</th>
