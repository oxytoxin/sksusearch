<div x-data="{ codeSent: @entangle('codeSent'), invalidCode: @entangle('invalid') }" x-cloak>
    ...
    @if ($show_Edit == false)
        <div>
            <h2 class="mb-4 font-light capitalize text-primary-600">Archives/ Legacy / Edit Uploaded Information / Input
                Edit
                ...
                <div class="flex flex-col p-5 rounded-lg shadow-md bg-primary-200 shadow-primary-600">
                    ...
                    <div class="flex justify-end gap-2 mt-2">
                        <button x-show="codeSent" type="button" x-on:click="$wire.sendCode()"
                            ...
                            <svg class="w-4 h-4 mr-3 -ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
    ...
    @else
        <div>
            <div class="flex justify-between mb-3">
                <h2 class="mb-4 font-light capitalize text-primary-600">Archives/ Legacy / Edit Uploaded Information
                </h2>
                <div class="flex flex-row">

                    <a href="{{ route('archiver.view-scanned-docs-lgc', [$ldc, '1']) }}"
                        class="filament-button bg-primary-300 hover:bg-primary-500 focus:bg-primary-700 focus:ring-offset-primary-700 border-primary-500 hover:text-primary-100 text-primary-800 float-right mx-3 inline-flex min-h-[2.25rem] items-center justify-center gap-1 rounded-lg border border-transparent py-1 px-4 text-sm font-medium capitalize shadow transition-colors hover:shadow-md hover:shadow-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white focus:ring-offset-2">
