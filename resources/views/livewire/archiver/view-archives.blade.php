<div class="space-y-2">
    ...
    <div x-data="{ tab: 'nl_docs' }" x-cloak>
        <div class="inline-flex flex-col mt-2 md:flex-row">
            ...
            <button @click="tab = 'chq'" :class="tab == 'chq' && 'bg-white -mt-2 text-primary-600'" class="px-4 py-2 mt-2 text-lg font-semibold rounded-t-lg hover:bg-primary-300">Stale / Cancelled Cheques</button>
        </div>
