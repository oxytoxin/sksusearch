                        ...
                        <div class="flex h-auto w-full items-start px-6 pt-4 print:pb-0 print:block">
                            <div id="header" class="block w-full items-start text-left">
                                ...
                                <div class="flex justify-between">
                                    <div class="space-x-4">
                                        <div class="">
                                                ...
                                                <span class="text-sm font-semibold tracking-wide text-black ">{{Carbon\Carbon::parse($request->created_at)->format('F d, Y')}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex justify-start">
                                    <div class="space-x-4">
                                        <div class="grid grid-cols-2">
                                            ...
                                            <span class="col-span-1 text-sm font-semibold tracking-wide text-black ">{{$request->slip_number}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex-col mt-8">
                                    ...
                                    <span class="text-sm font-semibold tracking-wide text-black ">{{$request->supplier->name}}</span>
                                    </div>
                                    <div class="space-x-5">
                                    <span class="text-sm font-semibold tracking-wide text-black">Address:</span>
                                    <span class="text-sm font-semibold tracking-wide text-black">{{$request->supplier->address}}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                                ...
                                                <tr class="p-2 ">
                                                    ...
                                                    <td class="border-t border-gray-800 text-center">
                                                        <div class="flex space-x-8 justify-center items-center">
                                                            <div>
                                                                <input disabled {{ $request->article === 'Gasoline' ? 'checked' : '' }} type="checkbox">
                                                                <label for="">Gasoline</label>
                                                            </div>
                                                            <div>
                                                                <input disabled {{ $request->article === 'Diesel' ? 'checked' : '' }} type="checkbox">
                                    ...
                                    <div class="flex-col mt-8">
                                        ...
                                        <span class="text-sm font-semibold tracking-wide text-black ">{{$request->purpose}}</span>
                                        </div>
                                        <div class="space-x-5">
                                        <span class="text-sm font-semibold tracking-wide text-black">Requested By : / Driver: </span>
                                        <span class="text-sm font-semibold tracking-wide text-black">{{$request->user->name}}</span>
                                        </div>
                                    </div>
                                </div>
                                @php
