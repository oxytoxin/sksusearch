<div>
    ...
    <div id="print_to" class="col-span-2">
        ...
        <div class="w-full">
            <div class="m-2 divide-y divide-black divide-solid print:divide-y-2">
                <div class="flex items-start w-full h-auto px-6 py-4 print:block">
                    <div id="header" class="items-start block w-full space-y-2 text-left">
                        <div class="flex justify-end">
                            <div>
                                <span
                                    class="text-md mr-10 font-bold text-black underline print:text-md">{{ date('F d, Y') }}</span>
                            </div>
                            <div>
                        ...
                        <div class="flex justify-end">
                            <div>
                                <span class="text-md mr-32 font-bold text-black print:text-md">P.O. # </span>
                                {{-- <span class="text-md font-bold text-black underline print:text-md">____________</span> --}}
                            </div>
                        </div>
                        <div class="flex">
                            <span
                                class="mx-auto text-lg mb-6 font-extrabold tracking-wide text-black uppercase print:text-lg">Driver's
                                Trip Ticket</span>
                        </div>
                        <div class="block">
                            {{-- <span
