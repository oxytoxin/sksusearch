            ...
            <div class="m-2">
                <div class="flex h-auto w-full items-start px-6 pt-4 print:pb-0 print:block">
                    <div id="header" class="block w-full items-start space-y-2 text-left">
                        <div class="flex justify-end">
                            <div>
                                <span
                                    class="text-md print:text-md mr-10 font-bold text-black underline">{{ date('F d, Y') }}</span>
                            </div>
                            <div>
                        ...
                        <div class="flex">
                            <span
                                class="mx-auto mb-6 text-lg font-extrabold uppercase tracking-wide text-black print:text-lg">Driver's
                                Trip Ticket</span>
                ...
                <div id="contents" class="flex h-auto w-full px-6 ml-2 pt-2 print:pt-1 print:text-12">
                    <div id="header" class="block w-full items-start text-left">
                        ...
                        <div class="block flex-wrap -space-y-1">
                            <span class="uppercase">9. <strong class="tracking-widest"> NAME OF AUTHORIZED
                                    passenger/S:</strong></span>
                            <span class="capitalize tracking-wide underline">
                                &nbsp
                        ...
                        <div class="grid grid-cols-5">
                            <div class="col-span-3 col-start-3 border-b border-black py-3 text-center">
                                {{ auth()->user()->employee_information->full_name }}</div>
                            <div class="col-span-3 col-start-3 row-start-2 text-center">(Head of Office or his Duly
                ...
                <div id="contents" class="flex h-auto w-full px-6 ml-2 pt-2 print:pt-1 print:text-12">
                    <div id="header" class="block w-full items-start text-left">
                        ...
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">11. Time of departure from the office/garage </div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">12. Time of arrival at (Para4, above)</div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">13. Time of departure from (Para 4, above)</div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">14. Time of arrival back ic office/garage</div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">15. Approximate distance to traveled to and from</div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        <div class="flex -space-y-1 columns-2">
                            <div class="inline whitespace-nowrap">16. Gasoline issued purchased and use</div>
                            <div class="border-b border-black block w-full"></div>
                        </div>
                        ...
                        <div class="ml-6">
                            ...
                            <div class="flex columns-3">
                                <div class="inline whitespace-nowrap ">f. Balance in tank</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                            <div class="flex columns-3">
                                <div class="inline whitespace-nowrap ">g. Issued office from stock</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                            <div class="flex columns-3">
                                <div class="inline whitespace-nowrap ">h. Add-purchased during trip</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                            <div class="flex columns-3 ml-48">
                                <div class="inline whitespace-nowrap ">Total</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                            <div class="flex columns-3">
                                <div class="inline whitespace-nowrap ">i. Deduct - used trip to and from</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                            <div class="flex columns-3">
                                <div class="inline whitespace-nowrap ">j. Balance in tank at the end of the trip</div>
                                <div class="border-b border-black block w-full"></div>
                                <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                            </div>
                        ...
                        <div class="flex columns-3">
                            <div class="inline whitespace-nowrap ">17. Gear oil issued</div>
                            <div class="border-b border-black block w-full"></div>
                            <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                        </div>
                        <div class="flex columns-3">
                            <div class="inline whitespace-nowrap ">18. Lubrication oil issued</div>
                            <div class="border-b border-black block w-full"></div>
                            <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                        </div>
                        <div class="flex columns-3">
                            <div class="inline whitespace-nowrap ">19. Grease issued</div>
                            <div class="border-b border-black block w-full"></div>
                            <div class="inline whitespace-nowrap pl-1">Liter/s</div>
                        </div>
                        <div class="flex columns-3">
                        ...
                        <div class="block pt-5">
                            <p class="indent-5">
                                I hereby certify to the correction of the above statement of the record of travel and
                                bind myself fully responsible for the car used and safety of this government vehicle
                                being used of the trip.
                            </p>
                            <p class="indent-5 mt-3">
                                I further certify that I know that the passenger is entitled to government
                                transportation. that the trip is an official one that I must follow strictly the
                                official nature of the trip without myself to be a party <strong
                                    class="text-red-500">[missing word/s on copy]</strong> the misuse or abuse of this
                                vehicle
                            </p>
                        </div>
