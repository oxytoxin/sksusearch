    ...
    <div id="printableDiv" class="p-6 bg-white shadow-md border border-gray-300 mx-auto max-w-3xl">
        ...
        <div class="mt-4">
            <p class="text-xs  text-gray-800 leading-relaxed">
                Pursuant to Section 3 of the Sanctions for Violations of Rules and Regulations Related to the Liquidation of
Cash Advances, as adopted through BOR Resolution No. 56, s. 2024, demand is hereby issued for the
