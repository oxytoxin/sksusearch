<div>
    ...
    FMR No. {{ $record->CaReminderStep->fmr_number ?? 'xxxx-xxxx' }}
    was issued to you on
{{ optional($record->CaReminderStep->fmr_date)->format('F d, Y') ?? '__________' }}
    in relation hereto.
</p>
                        ...
                        <p class="mt-4">In view of the foregoing premises, you are hereby ordered to effect the
                            immediate
                            liquidation of the cash advance described above. You are given the following alternatives,
                            which
                            must be
                            duly acted upon within five <br>(5) working days upon receipt of this notice:</p>
                        <ol class="pl-6 mt-2">
                            <li>(1) Liquidate the cash advance in full;</li>
                            <li>(2) Execute a Waiver for Deduction Against Personnel Pay (WDAPP) for the outstanding
                                balance
                                (OB) of
                                the cash advance; or</li>
                            <li>(3) Make partial liquidation of the cash advance and execute a Waiver for Deduction
                                Against
                ...
                <div class="text-xs mt-4 text-gray-800">
                    ...
                    <div class="mt-8 text-xs">
                        <p class="">
                            <sup>1</sup>Section 5 of CSC Memorandum Circular No. 23, s. 2019 | Section 53, Rule 10,
                            RRACCS
                            <br>
                            <sup>2</sup>Paragraph 9.3.3, COA Circular No. 97-002 | Section 89 & 128, PD No. 1445 |
                            Article
                            218,
                    ...
                    <p class="mt-4 text-xs ">
                        ...
                        settlement by ticking the applicable checkbox in the lower right of this document. If you
                        received
                        this
