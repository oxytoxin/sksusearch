...
{{--
    ...
    <div class="w-1/3 p-4 bg-white border border-gray-300 rounded-lg shadow-md">

        {{-- <h3 class="text-lg font-bold mb-2">Message & Reply Section</h3> --}}
        <div class="p-3 h-full">
            ...
            <textarea class="w-full mt-2 p-2 border rounded-lg" placeholder="Type your message..."></textarea>
            <button class="mt-2 px-4 py-2 bg-primary-500 text-white rounded">Send</button>
        </div>
    </div>
</div>
