<div>
    <div id="printableDiv" class="p-6 bg-white shadow-md border border-gray-300 mx-auto max-w-3xl">
        ...
        <h2 class="text-center text-xl font-bold underline mb-6">Show Cause Order</h2>

        <p><strong>Date:</strong> [Date]</p>
        <p><strong>To:</strong> [NAME]</p>

        <p class="mt-4">You are hereby ORDERED TO SHOW CAUSE in writing as to why you should not be cited...</p>
