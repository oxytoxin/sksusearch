<div class="mx-auto w-full max-w-[13in] bg-white font-serif text-[11px] leading-[1.12] text-black print:max-w-none print:text-10 print:[-webkit-print-color-adjust:exact] print:[print-color-adjust:exact]">
    ...
    <table class="w-full table-fixed border-collapse border-2 border-black">
        ...
        <thead>
            <tr>
                <td class="border border-black px-1 py-0.5 align-top" colspan="4">
                    <div><span class="font-bold">Name :</span> <span class="font-bold">{{ $itineraryForm['traveler']['name'] }}</span></div>
                ...
                <td class="border border-black px-1 py-0.5 align-top" colspan="5">
                    ...
                    <div><span class="font-bold">Purpose of Travel :</span> <span class="whitespace-pre-line">{{ $itineraryForm['purpose'] }}</span></div>
                </td>
            </tr>
            <tr>
                <th class="border border-black px-1 py-0.5 text-center align-top font-bold" rowspan="2">Date</th>
                <th class="border border-black px-1 py-0.5 text-center align-top font-bold" rowspan="2">Places to be visited<br>(Destination)</th>
                <th class="border border-black px-1 py-0.5 text-center align-top font-bold" colspan="2">T I M E</th>
                <th class="border border-black px-1 py-0.5 text-center align-top font-bold" rowspan="2">Means of<br>Transportation</th>
                <th class="border border-black px-1 py-0.5 text-center align-top font-bold" rowspan="2">Transpor-<br>tation</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="border border-black border-t-2 px-1 py-0.5 text-center align-top font-bold" colspan="5">TOTAL</td>
