<div class="p-8">
    <div class="flex justify-end w-full px-2">
        <button class="flex px-4 py-2 text-center rounded-md bg-primary-700 text-primary-100 hover:bg-primary-900 hover:shadow-primary-600 hover:shadow-sm" onclick="printDiv('dvPrint')">
    ...
    <div class="rounded-lg bg-white font-serif print:block print:h-[297mm] print:max-h-[297mm] print:w-[220mm] print:max-w-[220mm] print:rounded-none print:font-serif" id="dvPrint">
