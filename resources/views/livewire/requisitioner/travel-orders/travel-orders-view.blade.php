    ...
    <div class="grid grid-cols-1 lg:grid-cols-3">
        ...
        <div class="col-span-1 px-4 py-5 ml-4 bg-white border-b rounded-md border-primary-300 md:rounded-l-none md:rounded-r-3xl">
            ...
            @if ($travel_order->sidenotes->count())
                <div class="mt-6">
                    <a href="#" class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium bg-white border rounded-md shadow-sm text-primary-700 border-primary-300 hover:bg-primary-50">
                        View all</a>
                </div>
            @endif
        </div>
