<div class="">
    <div class="grid grid-cols-1 lg:grid-cols-3">
        <div class="flex-row col-span-1 lg:col-span-2">
			...
			<div class="px-4 py-5 bg-white border-b rounded-md border-primary-200 sm:px-6 md:rounded-none md:rounded-tl-lg">
							...
							@else
								<a target="_blank" href="{{ route('requisitioner.itinerary.create') }}"
									...
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
										stroke="currentColor" class="w-5 h-auto">
            ...
            <div class="px-4 py-5 mt-5 bg-white border-b rounded-md border-primary-200 sm:px-6 md:rounded-none md:rounded-bl-lg">
                <div class="flex flex-wrap items-center justify-between -mt-4 -ml-4 sm:flex-nowrap">
                    <div class="mt-4 ml-4">
        ...
        <div class="col-span-1 px-4 py-5 ml-4 bg-white border-b rounded-md border-primary-300 md:rounded-l-none md:rounded-r-3xl">
            ...
            @if ($travel_order->sidenotes->count() >= 1)
                <div class="mt-6">
                    <a href="#" class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium bg-white border rounded-md shadow-sm text-primary-700 border-primary-300 hover:bg-primary-50">View
                        all</a>
                </div>
            @endif
        </div>
