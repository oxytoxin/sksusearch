<div class="">
    <div class="grid grid-cols-1 lg:grid-cols-3">
        <div class="col-span-1 flex-row lg:col-span-2">
            ...
            <div
                class="border-primary-200 rounded-md border-b bg-white px-4 py-5 sm:px-6 md:rounded-none md:rounded-tl-lg">
            ...
            <div
                class="border-primary-200 mt-5 rounded-md border-b bg-white px-4 py-5 sm:px-6 md:rounded-none md:rounded-bl-lg">
                <div class="-mt-4 -ml-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                    <div class="mt-4 ml-4">
