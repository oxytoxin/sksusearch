<div class="">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3">
        <div class="flex-row col-span-1 lg:col-span-2">
            ...
            <div
                class="px-4 py-5 bg-white border-b rounded-md border-primary-200 sm:px-6 md:rounded-none md:rounded-t-lg">
            ...
            <div
                class="px-4 py-5 mt-2 bg-white border-b rounded-md border-primary-200 sm:px-6 md:rounded-none md:rounded-b-lg">
                    ...
                    <div class="flex justify-between w-full">
                        ...
                        <button type="button" wire:click="$set('modal',true)" class="flex px-4 my-auto text-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-auto h-3 my-auto">
                            ...
                            <li class="py-5">
                                <div class="relative focus-within:ring-2 focus-within:ring-indigo-500">
                                    <h3 class="flex justify-between text-sm font-semibold text-primary-800">
                                        ...
                                        <span
                                            class="flex">{{ $sidenote->user->employee_information->full_name }}</span>
