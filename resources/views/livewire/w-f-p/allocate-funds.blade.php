<div class="space-y-2">
    ...
    <div class="grid grid-cols-2 space-x-3">
        <div class="col-span-1 lg:col-start-1 lg:row-end-1">
            ...
            @if ($record->fundClusterWFP->id === 2 || $record->fundClusterWFP->id === 4 || $record->fundClusterWFP->id === 5 || $record->fundClusterWFP->id === 6 || $record->fundClusterWFP->id === 7)
            <div class="flex justify-end mt-2">
                <button wire:loading.attr="disabled" wire:click="confirmAllocation161" class="flex hover:bg-primary-500 p-2 bg-primary-600 rounded-md font-light capitalize text-white text-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
