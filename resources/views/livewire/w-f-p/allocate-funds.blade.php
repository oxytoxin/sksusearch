    ...
    <div class="grid grid-cols-2 space-x-3">
        <div class="col-span-1 lg:col-start-1 lg:row-end-1">
            ...
            <div class="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
                <dl class="flex flex-wrap">
                    <div class="flex-auto pl-6 pt-4">
                        <dt class="text-sm font-semibold leading-6 text-gray-900">Fund -
                            {{ $record->fundClusterWFP->name }}</dt>
                        <dd class="mt-1 text-sm font-bold leading-6 text-gray-900">

                        </dd>
                        <dd>
                            <select wire:model.live="selectedType" id="small"
                                ...
                                <option value="" selected>Select WFP Period</option>
                ...
                @else
                    ...
                    <div class="my-4 flex w-full flex-none gap-x-4 px-6">
                        ...
                        <dd class="text-sm font-medium leading-6 text-gray-900">{{ $record->mfoFee?->name }} - MFO Fee
                        </dd>
                    </div>
                    <div class="border-t border-gray-900/5 px-6 py-3">
                            ...
                            <div class="mt-4 flow-root">
                                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                        <div
                                            ...
                                            <div>
                                                <div class="relative rounded-md shadow-sm">
                                                    ...
                                                    <input wire:model.live="fundInitialAmount" type="number"
                                                        name="price" id="price"
                                        ...
                                        @error('fundInitialAmount')
                                            <span class="text-sm text-red-600">{{ $message }}</span>
                                        @enderror
                                        <div class="py-3">
                                            <textarea wire:model.live="fund_description" id="message" rows="4"
                                    ...
                                    <tbody>
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <td class="py-3 pl-3 pr-4 text-right text-sm text-gray-500 sm:pr-0">₱
                                                {{ number_format($fundInitialAmount, 2) }}</td>
                                        </tr>
            ...
            @if (
                ...
                <div class="flex justify-end mt-2">
                    <button wire:loading.attr="disabled" wire:click="confirmAllocation161"
        ...
        @if (in_array($record->fundClusterWFP->id, [1, 3, 9]))
            <div class="col-span-1 lg:col-start-2 lg:row-end-1">
                ...
                <div class="flex justify-end mt-2">
                    <button wire:click="confirmAllocation"
                        class="flex hover:bg-primary-500 p-2 bg-primary-600 rounded-md font-light capitalize text-white text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
                            <path stroke-linecap="round" stroke-linejoin="round"
