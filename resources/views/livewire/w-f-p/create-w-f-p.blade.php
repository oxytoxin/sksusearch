<div class="space-y-2">
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('wfp.select-wfp') }}" class="flex hover:bg-gray-500 p-2 bg-gray-600 rounded-md font-light capitalize text-white text-sm">
                ...
                <div>
                    <div class="flex-col text-sm w-full font-medium divide-y-2 divide-gray-800">
                        ...
                        <div class="py-2">
                            ...
                            <span class="text-center">{{$costCenter->office->head_employee?->full_name.' - '.$costCenter->office->name}}</span>
                        </div>
              ...
              <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="grid grid-cols-3 space-x-24 min-w-full py-1 align-middle sm:px-6 lg:px-8">
                            ...
                            <table class="min-w-full">
                                <thead class="bg-green-800">
                                    ...
                                    <tr class="border-t border-gray-300" x-show="!open">
                                        ...
                                        <td class="whitespace-nowrap py-3 pl-4 pr-3 text-right text-sm font-medium {{$item['initial_amount'] >= $item['current_total'] ? 'text-gray-900' : 'text-red-600'}} sm:pl-3">₱ {{number_format(($item['initial_amount'] - $item['current_total']), 2)}}</td>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <div class="flex justify-between mt-6">
                                @if ($global_index > 1)
                                    <button wire:click="decreaseStep" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-1.5 px-3 rounded-lg">
                                        Back
                                    </button>
                                @endif
                  ...
                  <div wire:ignore.self>
                    <x-modal.card title="Work & Financial Plan Preview" fullscreen blur wire:model.defer="suppliesDetailModal">
                                ...
                                <div class="mt-2 grid grid-cols-3">
                                    <div class="col-span-1">
                                        ...
                                        <p class="mt-2 text-sm text-gray-700">Fund:
                                            {{$wfp_fund->name}} {{$fund_description === null ? '' : '- '.$fund_description}}</p>
                                    </div>
                                    <div class="col-span-1">
                                        <p class="mt-2 text-sm text-gray-700">Source of Fund: {{$source_fund}}</p>
                                        <p class="mt-2 text-sm text-gray-700">if miscellaneous/fiduciary fee, please specify: {{$confirm_fund_source ?? 'N/A'}}</p>
                                    </div>
                                    <div class="col-span-1">
                                        <p class="mt-2 text-sm text-gray-700">Cost Center: {{$costCenter->name}}</p>
                                        <p class="mt-2 text-sm text-gray-700">Cost Center Head: {{$costCenter->office->head_employee?->full_name.' - '.$costCenter->office->name}}</p>
                                    </div>
                                </div>
                                        ...
                                        <tbody class="bg-white">
                                            ...
                                            <tr class="border-t border-gray-200">
                                              ...
                                              <tr class="border-t border-gray-300">
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                                  <button wire:click="deleteSupply({{$loop->index}})" class="text-red-600 hover:text-red-900">
                                            ...
                                            <tr class="border-t border-gray-200">
                                              ...
                                              <tr class="border-t border-gray-300">
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                                    <button wire:click="deleteMooe({{$loop->index}})" class="text-red-600 hover:text-red-900">
                                                        <svg class="w-5 h-5 text-red-600 hover:text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                          </svg>
                                                    </button>
                                            ...
                                            <tr class="border-t border-gray-200">
                                              ...
                                              <tr class="border-t border-gray-300">
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                                    <button wire:click="deleteTraining({{$loop->index}})" class="">
                                                        <svg class="w-5 h-5 text-red-600 hover:text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                          </svg>
                                                    </button>
                                            ...
                                            <tr class="border-t border-gray-200">
                                              ...
                                              <tr class="border-t border-gray-300">
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                                    <button wire:click="deleteMachine({{$loop->index}})" class="text-red-600 hover:text-red-900">
                                                        <svg class="w-5 h-5 text-red-600 hover:text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                          </svg>
                                                    </button>
