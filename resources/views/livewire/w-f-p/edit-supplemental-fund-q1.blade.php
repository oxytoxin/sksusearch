<div class="space-y-2">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('wfp.fund-allocation', $record->fundClusterWFP->id) }}" class="flex hover:bg-yellow-500 p-2 bg-yellow-600 rounded-md font-light capitalize text-white text-sm">
    ...
    <div class="grid grid-cols-2 space-x-3">
          ...
          <div class="col-span-1 lg:col-start-2">
            ...
            <div class="flex justify-end mt-2 space-x-3">
                <button wire:click="confirmSupplementalFund" class="flex hover:bg-primary-500 p-2 bg-primary-600 rounded-md font-light capitalize text-white text-sm">
          ...
          <div class="col-span-1 lg:col-start-1 bg-gray-50 rounded-lg shadow-sm ring-1 ring-gray-900/5">
            <div class="flex w-full flex-none gap-x-4 px-6 pt-3">
                      ...
                      <table class="min-w-full">
                        ...
                        <thead class="border-b border-gray-300 text-gray-900">
                          <tr>
                            ...
                            <th scope="col" class="hidden px-3 py-3.5 text-right text-sm font-semibold text-gray-900 sm:table-cell"></th>
                            <th scope="col" class="hidden px-3 py-3.5 text-right text-sm font-semibold text-gray-900 sm:table-cell"></th>
                            <th scope="col" class="py-3.5 pl-20 pr-4 text-right text-sm font-semibold text-gray-900 sm:pr-0">Balance</th>
                            <th scope="col" class="py-3.5 pl-20 pr-4 text-right text-sm font-semibold text-gray-900 sm:pr-0">Supplemental</th>
                            <th scope="col" class="py-3.5 pl-24 pr-4 text-right text-sm font-semibold text-gray-900 sm:pr-0">Sub Total</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b border-gray-200">
                              ...
                              <tr class="border-b border-gray-200">
                                ...
                                <td class="hidden px-3 py-3 text-right text-sm text-gray-500 sm:table-cell"></td>
                                <td class="hidden px-3 py-3 text-right text-sm text-gray-500 sm:table-cell"></td>
                                <td class="py-3 pl-3 pr-4 text-right text-sm text-gray-500 sm:pr-0">₱ {{ number_format($balance_164_q1, 2) }}</td>
              ...
              <div class="flex justify-end mt-2 space-x-3">
                <button wire:click="confirmUpdateSupplementalFund164" class="flex hover:bg-primary-500 p-2 bg-primary-600 rounded-md font-light capitalize text-white text-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                      </svg>
                    Update
