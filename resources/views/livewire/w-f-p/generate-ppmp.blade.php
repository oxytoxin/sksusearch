        ...
        <div x-cloak x-data="{ selectedTab: '101' , showPrintable: false}">
            ...
            <div class="mt-5">
                <div class="flex justify-start items-center">
                    <select wire:model.defer="selectedType" id="wfp_type" name="wfp_type" class="block w-1/2 rounded-md border-gray-300 focus:border-green-500 focus:ring-green-500">
