...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-4 bg-white pt-1 border-b-2 border-white text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition mt-2 rounded-t-lg'
